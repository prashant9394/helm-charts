...
The following table lists the configurable parameters of the Tee-attestation-orchestration chart and their default values.
...
| `global-admin-generator.services_list` | Services list for global admin token generation. Accepted values HVS, WLS, KBS, APS, FDS, TA, QVS, TCS | `["APS", "FDS", "TCS", "KBS", "QVS"]` |
...
| `global.fdsUrl` | Fds Base Url, Do not include "/" at the end. e.g for ingress https://fds.isecl.com/fds/v2 , for nodeport  https://<control-plane-hostname/control-plane-IP>:30500/fds/v1 | `"<user input>"` |
